...
--
-- Host: 127.0.0.1
-- Waktu pembuatan: 30 Mar 2020 pada 13.52
...
CREATE TABLE `booking_detail` (
  ...
  `id_booking` int(12) DEFAULT NULL,
...
(1, 'Statistika dengan Program Komputer', 1, 'Ahmad Kholiqul Amin', 'Deep Publish', 2014, '9786022809432', 6, 1, 1, '1.jpg'),
...
CREATE TABLE `detail_pinjam` (
  `no_pinjam` varchar(12) CHARACTER SET utf8mb4 DEFAULT NULL,
  `id_buku` int(11) NOT NULL,
...
CREATE TABLE `pinjam` (
  ...
  `status` enum('pinjam','kembali') CHARACTER SET utf8 DEFAULT 'pinjam',
...
(1, 'tenny sabrina', 'tennysabrina08@gmail.om', '1.jpg', '*FF6501E69E7222E05A443D2DBFF1A6B05E7CD3E6', 1, 1, 12081998),
